...
public class GenericKeyedObjectPool<K, V> extends BaseKeyedObjectPool<K, V> {
     ...
     * @param config a non-<code>null</code> {@link Config} describing the configuration
     */
     ...
     * @see GenericKeyedObjectPool#GenericKeyedObjectPool(KeyedPoolableObjectFactory, Config)
